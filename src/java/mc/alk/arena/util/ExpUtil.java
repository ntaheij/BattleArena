...
/**
 * Never use player.getTotalExperience() because it can return an incorrect value 
 * because Bukkit does not update experience after spending it on enchants.
 * 
 * @author alkarin
 * version: 1.4
 *
...
public class ExpUtil {
    ...
    /**
     * New XP math for Minecraft 1.8
     * Credits go to andrewkm for the 1.8 code
     */
